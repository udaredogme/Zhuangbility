    ...
    <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
            <ul class="nav nav-sidebar">
                ...
                <li class="active" ><a href="/staff/list"><span class="glyphicon glyphicon-menu-right" aria-hidden="true"> </span>职工信息<span class="sr-only">(current)</span></a></li>
            </ul>
            <ul class="nav nav-sidebar">
