...
<div class="container">
    ...
    <form:form class="form-signin" method="POST" commandName="course" action="${pageContext.request.contextPath}/editinfo/edit_cou/${course.id}.html">
    <h2 class="form-signin-heading">修改课程</h2>
